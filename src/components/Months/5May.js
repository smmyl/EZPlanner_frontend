        ...
        <>
            <div class='grid flex-grow w-full h-auto grid-cols-7 grid-rows-5 gap-px pt-px mt-1 bg-gray-200'>
                <div class='relative flex flex-col bg-gray group'>
                    ...
                    <button class='absolute bottom-0 right-0 flex items-center justify-center hidden w-4 h-4 mb-2 mr-2 text-white bg-gray-400 rounded group-hover:flex hover:bg-gray-500' onClick={viewToggle}>
                ...
                <div class='relative flex flex-col bg-white group'>
                    ...
                    <div class='flex flex-col px-1 py-1 overflow-auto'>
                        <button class='flex items-center flex-shrink-0 h-5 px-1 text-md hover:bg-gray-200'>
                            <span class='ml-1 font-light leading-none'>9:00am</span>
                            <span class='ml-1 font-medium leading-none truncate'>Capstone</span>
                        </button>
                    </div>
                    <button class='absolute bottom-0 right-0 flex items-center justify-center hidden w-4 h-4 mb-2 mr-2 text-white bg-gray-400 rounded group-hover:flex hover:bg-gray-500' onClick={viewToggle}>
                        <img src='https://img.icons8.com/?size=512&id=30M9wv1iFkcH&format=png'/>
                ...
                <div class='relative flex flex-col bg-white group'>
                    ...
                    <div class='flex flex-col px-1 py-1 overflow-auto'>
                        <button class='flex items-center flex-shrink-0 h-5 px-1 text-md hover:bg-gray-200'>
                            <span class='ml-1 font-light leading-none'>12:30pm</span>
                            <span class='ml-1 font-medium leading-none truncate'>Dental Cleaning</span>
                        </button>
                        <div class='flex flex-col px-1 py-1 overflow-auto'>
                        <button class='flex items-center flex-shrink-0 h-5 px-1 text-md hover:bg-gray-200'>
                            <span class='ml-1 font-light leading-none'>6:30pm</span>
                            <span class='ml-1 font-medium leading-none truncate'>Dinner</span>
                        </button>
                    </div>
                    </div>
                    <div class='flex flex-col px-1 py-1 overflow-auto'/>
                ...
                <div class='relative flex flex-col bg-white group'>
                    ...
                    <div class='flex flex-col px-1 py-1 overflow-auto'>
                        <button class='flex items-center flex-shrink-0 h-5 px-1 text-md hover:bg-gray-200'>
                            <span class='ml-1 font-light leading-none'>6:00pm</span>
                            <span class='ml-1 font-medium leading-none truncate'>Haircut</span>
                        </button>
                    </div>
                    <div class='flex flex-col px-1 py-1 overflow-auto'/>
                    <button class='absolute bottom-0 right-0 flex items-center justify-center hidden w-4 h-4 mb-2 mr-2 text-white bg-gray-400 rounded group-hover:flex hover:bg-gray-500' onClick={viewToggle}>
                ...
                <div class='relative flex flex-col bg-white group'>
                    ...
                    <div class='flex flex-col px-1 py-1 overflow-auto'>
                        <button class='flex items-center flex-shrink-0 h-5 px-1 text-md hover:bg-gray-200'>
                            <span class='ml-1 font-light leading-none'>9:00pm</span>
                            <span class='ml-1 font-medium leading-none truncate'>Party</span>
                        </button>
                    </div>
                    <div class='flex flex-col px-1 py-1 overflow-auto'/>
                    <button class='absolute bottom-0 right-0 flex items-center justify-center hidden w-4 h-4 mb-2 mr-2 text-white bg-gray-400 rounded group-hover:flex hover:bg-gray-500' onClick={viewToggle}>
                    ...
                    <div class="relative w-full max-w-xl max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-6 space-y-6 text-white">
                                <p class='text-xl'>12:30 PM dental cleaning</p>
                                <p class='pl-5'>@ tufts dental</p>
                                <p class='text-xl'>6:30 PM Dinner</p>
                                <p class='pl-5'>sending Sean away to San Fran @ Del Frisco's</p>
                            </div>
