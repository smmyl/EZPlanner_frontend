...
const Home = (props) => {
    ...
    const handleSubmit = (event) => {
        ...
        props.handleCreateNotesInfo(addedNote)
    }

    return (
        <>
            <div class='container mx-auto flex flex-col py-5 rounded-xl'>
                <div class='px-10 py-10 mt-5 rounded-3xl shadow-2xl flex flex-col justify-center border-y-8 border-white' id={props.weather.icon}>
                    ...
                    <div class='conditionbg2 text-center'>
                        ...
                        <p>Humidity: <span class='weatherspan'>{props.weather.humidity}%</span></p>
                ...
                <div class='flex flex-row'>
                    <div class='flex flex-col px-5 py-5'>
                        ...
                        <ul class='flex pt-10 flex-wrap' id='socialicons'>
                            <li class='mr-6 p-2'>
                                <a href='https://gmail.com' target='_blank'>
                                    <svg xmlns='http://www.w3.org/2000/svg' width='60' height='60' data-name='Layer 1' viewBox='0 0 32 32' id='gmail'>
                            ...
                            <li class='mr-6 p-2'>
                                <a href='https://github.com/' target='_blank'>
                                    <img width='60' height='60' src='https://cdn4.iconfinder.com/data/icons/social-media-logos-6/512/71-github-512.png'></img>
                                </a>
                            </li>
                            <li class='mr-6 p-2'>
                                <a href='https://facebook.com/' target='_blank'>
                                    <img width='60' height='60' src='https://img.icons8.com/?size=512&id=13912&format=png'></img>
                                </a>
                            </li>
                            <li class='mr-6 p-2'>
                                <a href='https://linkedin.com/' target='_blank'>
                                    <img width='60' height='60' src='https://img.icons8.com/?size=512&id=xuvGCOXi8Wyg&format=png'></img>
                                </a>
                            </li>
                            <li class='mr-6 p-2'>
                                <a href='https://instagram.com/' target='_blank'>
                                    <img width='60' height='60' src='https://img.icons8.com/?size=512&id=Xy10Jcu1L2Su&format=png'></img>
                                </a>
                            </li>
                            <li class='mr-6 p-2'>
                                <a href='https://twitter.com/' target='_blank'>
                                    <img width='60' height='60' src='https://img.icons8.com/?size=512&id=13963&format=png'></img>
                                </a>
                            </li>
                            <li class='mr-6 p-2'>
                                <a href='https://imgur.com/' target='_blank'>
                                    <img width='60' height='60' src='https://img.icons8.com/?size=512&id=PzIW15hY5DKB&format=png'></img>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div id='notepadcont flex'>
                        <form onSubmit={handleSubmit}class='text-center'>
                            ...
                            <input class='-mb-2 ml-2' type='image' src='https://img.icons8.com/?size=512&id=102544&format=png' width='30' alt='submit'></input>
                            <br/>
                            <textarea id='notepad' type='text' name='notes' rows='15' cols='50' onChange={handleChange}/>
                        </form>
                    </div>
                </div>
            </div>
